...
참고로 Handler_read_next는 인덱스 역순으로 읽은 레코드 건수 입니다.
...
- 그래서 인덱스 스킵 스캔은 인덱스의 선행 컬럼이 가진 유니크한 값의 개수가 소량일 떄만 적용 가능한 최적화라는 점을 기억해야 한다.
...
- 사실 그 인덱스를 거꾸로 끝에서부터 읽으면 내림찬수으로 정렬된 인덱스로도 사용될 수 있습니다.
